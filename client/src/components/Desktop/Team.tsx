...
export default function Team() {
  ...
  return (
    <div className="w-[66vw] h-[66vh] border border-solid border-[#C89B3C] rounded-2xl xl:px-[3vw] xl:py-[3vh] lg:px-[2vw] lg:py-[2vh] flex flex-col gap-[20px] bg-[#F0E6D2] bg-opacity-30">
      {/* Red Team 영역 */}
