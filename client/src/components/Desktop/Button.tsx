...
const Button: React.FC<ButtonProps> = ({ setHeaderText }) => {
  ...
  return (
    <div className="lg:absolute lg:top-[-65px] lg:right-[0px] flex flex-col items-center justify-start md:mt-7 md:mb-7 lg:mt-3 lg:mb-3 lg:mx-auto lg:left-0 lg:right-0">
